<script>
	import bgft from '$lib/assets/img/background_ft.svg';
	import bghead from '$lib/assets/img/bghead.png';
	import Fulllogo from '$lib/components/fulllogo.svelte';
